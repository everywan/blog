...
车型分类如下 _参考[公路車三大車系完全解析](http://www.cycling-update.info/activity/new-arrival/1203-2015-07-02-09-33-18)_
- TCR: 车轻爬坡型, 主要针对丘陵地或高山路线的骑行, 以挑战连续的爬坡路况. 介于 DEFY与Propel 之间.
- DEFY: 长久舒适型, 主要针对长距离的骑行, 以舒适为主. 可用于 全天候路况、环路、距离200km以上的骑行或是颠簸的石板路。
- Propel: 空气力学型, 主要针对风阻进行优化, 提升骑行速度为主. 计时车, 多用于骑行比赛.
